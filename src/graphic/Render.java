     ...
     public static BufferedImage getImage(List<Model> models, int height, int width, Matrix3 transform){
        ...
        for (Triangle t : m.getMatrix()) {
          ...
          /*  Vertex v1 = t.getV1();
            Vertex v2 = t.getV2();
            Vertex v3 = t.getV3();
          *///  triangles.add( new Triangle(v1, v2, v3, t.color) );
/*
            v1.x += (double)width / 2;
  ...
  */          
      ...
      //                      colors[y*img.getWidth() + x] = t.color.getRGB();
                        }
                    }
                }
            }
    ...
    //    img.setRGB(0, 0, width, height, colors, 0, 0);
      //  coordinats.setTriangle(triangles);
        return img;
    }
}
